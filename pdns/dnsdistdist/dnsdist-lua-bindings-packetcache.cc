...
{
  /* PacketCache */
  luaCtx.writeFunction("newPacketCache", [client](size_t maxEntries, std::optional<LuaAssociativeTable<boost::variant<std::string, bool, size_t, LuaArray<uint16_t>>>> vars) {
